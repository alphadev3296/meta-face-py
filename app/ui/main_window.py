...
class CameraPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, status_callback):
        ...
        self.camera_combo = ttk.Combobox(self, textvariable=self.camera_var, 
        ...
        self.resolution_combo = ttk.Combobox(self, textvariable=self.resolution_var,
                                             values=["VGA (640x480)", "HD/2 (960x540)", 
        ...
        self.fps_combo = ttk.Combobox(self, textvariable=self.fps_var,
                                      values=["5", "10", "25"],
                                      state="readonly", width=15)
...
class ServerPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, status_callback):
        ...
        self.secret_entry = ttk.Entry(self, textvariable=self.secret_var, 
                                      show="*", width=18)
    ...
    def on_secret_change(self, event=None):
...
class ProcessingPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, status_callback):
        ...
        # Photo selection
        self.select_btn = ttk.Button(self, text="Select Photo", 
                                     command=self.select_photo, width=18)
        ...
        self.preview_label = ttk.Label(self.preview_frame, text="No photo selected", 
                                       anchor="center")
        self.preview_label.pack(fill="both", expand=True)
        
        # FaceSwap checkbox
        self.faceswap_var = tk.BooleanVar()
        self.faceswap_cb = ttk.Checkbutton(self, text="FaceSwap", 
                                           variable=self.faceswap_var,
                                           command=self.on_faceswap_toggle)
        self.faceswap_cb.grid(row=2, column=0, sticky="w", pady=2)
        
        # FaceEnhance checkbox
        self.faceenhance_var = tk.BooleanVar()
        self.faceenhance_cb = ttk.Checkbutton(self, text="FaceEnhance",
                                              variable=self.faceenhance_var,
                                              command=self.on_faceenhance_toggle)
...
class LocalVideoPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, status_callback):
        ...
        self.show_cb = ttk.Checkbutton(self, text="Show Local Video",
                                       variable=self.show_var,
                                       command=self.on_show_toggle)
        ...
        self.preview_label = ttk.Label(self.preview_frame, text="Local Preview",
                                       anchor="center", background="gray20",
                                       foreground="white")
        self.preview_label.pack(fill="both", expand=True)
...
class StreamControlPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent, status_callback):
        ...
        self.connect_btn = ttk.Button(self, text="Connect", 
                                     command=self.on_connect, width=18)
...
class VideoPreviewPanel(ttk.LabelFrame):
    ...
    def __init__(self, parent):
        ...
        self.preview_label = ttk.Label(self, text="Camera Preview",
                                       anchor="center", background="gray30",
                                       foreground="white")
        self.preview_label.pack(fill="both", expand=True)
